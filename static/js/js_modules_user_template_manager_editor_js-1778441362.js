"use strict";
(self["rspackChunkfidus_writer"] = self["rspackChunkfidus_writer"] || []).push([["js_modules_user_template_manager_editor_js"], {
...
class DocTemplatesEditor {
    ...
    init() {
        ...
        return this.app.csl
            ...
            .then(styles => {
                ...
                return (0,_common__rspack_import_0.postJson)("/api/user_template_manager/get/", {
                    id: this.id
                })
            })
            .then(({json}) => {
    ...
    save() {
        ...
        if (!valid) {
            ...
            return (0,_common__rspack_import_0.post)("/api/user_template_manager/save/", {
                id: this.id,
                value,
                import_id,
                title
