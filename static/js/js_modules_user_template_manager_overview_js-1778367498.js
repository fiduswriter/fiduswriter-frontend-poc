"use strict";
(self["webpackChunkfidus_writer"] = self["webpackChunkfidus_writer"] || []).push([["js_modules_user_template_manager_overview_js"], {
...
class DocTemplatesActions {
    ...
    deleteDocTemplate(id) {
        ...
        (0,_common__rspack_import_0.jsonPostJson)("/api/user_template_manager/delete/", {id})
            .catch(error => {
    ...
    copyDocTemplate(oldDocTemplate) {
        return (0,_common__rspack_import_0.jsonPostJson)("/api/user_template_manager/copy/", {
